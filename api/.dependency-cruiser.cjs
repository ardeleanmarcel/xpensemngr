  ...
  forbidden: [
    ...
    },
    {
      ...
      to: {
        ...
        pathNot: [
          // Add exceptions for common package imports
          '^node_modules/(zod|bcrypt|lodash|jsonwebtoken|@trpc/server)/',
          // Add exception for TypeScript declaration files
          '[.]d[.]ts$',
        ],
      },
    },
...
// generated: dependency-cruiser@16.10.2 on 2025-06-04T15:16:12.896Z
