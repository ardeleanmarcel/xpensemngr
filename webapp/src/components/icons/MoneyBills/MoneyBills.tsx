...
// TODO (Valle) -> use this type for all icons
export type IconComponent = React.FunctionComponent<IconProps>;

export const MoneyBills: React.FunctionComponent = (props) => {
  return (
    <svg style={{ width: '24px', height: '24px' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" {...props}>
