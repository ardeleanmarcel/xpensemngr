...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      from: {
        pathNot: ['src/components/icons/icon.types.tsx'],
      },
      to: {
    ...
    },
    {
      ...
      from: {
        path: '^(src)',
        pathNot: ['[.](?:spec|test)[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)$', 'src/vite-env.d.ts'],
      },
      to: {
...
// generated: dependency-cruiser@16.10.2 on 2025-06-13T16:52:26.755Z
